...
INDEX_NAME = os.getenv('INDEX_NAME', 'preprod_index')
REGION = os.getenv('REGION', 'us-west-2')
HOST = os.getenv('HOST', 'https://ft9umsemmpbp0anq2s6e.us-west-2.aoss.amazonaws.com')
...
# Add this at the top of your file to allow nested event loops
nest_asyncio.apply()
...
def lambda_handler_load(event, context):
    ...
    try:
        ...
        for record in event['Records']:
            ...
            result = loop.run_until_complete(handler(record))
